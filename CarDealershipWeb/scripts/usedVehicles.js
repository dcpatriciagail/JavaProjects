$(document).ready(function () {
    ...
    // Loads the Used Vehicles
$('#search-button').click(function (event) {
var contentRows = $('#contentRows');
    contentRows.empty();
$.ajax({
    type: 'GET',
    url: 'http://localhost:8080/cardealership/inventory/used?makeOrModel='+$('#search-value').val()+'&minYear='+$('#min-year-selection :selected').val()+'&maxYear='+$('#max-year-selection :selected').val()+'&minPrice='+$('#min-price-selection :selected').val()+'&maxPrice='+$('#max-price-selection :selected').val(),
